...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(com.goldsikka.goldsikka.Activitys.Events.LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(com.goldsikka.goldsikka.Activitys.Events.LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(com.goldsikka.goldsikka.Activitys.Events.LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
