...
public class Ecommerce_Home_Adapter extends RecyclerView.Adapter<Ecommerce_Home_Adapter.ViewHolder> {
    ...
    public Ecommerce_Home_Adapter(Context context, ArrayList<Listmodel> list, OnItemClickListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.activity_ecom_category_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Log.e("iddd", "" + listmodel.getId());
        Log.e("iddd", "" + listmodel.getCatid());
        Log.e("iddd", "" + listmodel.getPid());
        Log.e("iddd", "" + listmodel.getPids());
