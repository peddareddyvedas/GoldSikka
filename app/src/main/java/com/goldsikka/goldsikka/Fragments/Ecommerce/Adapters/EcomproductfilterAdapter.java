...
public class EcomproductfilterAdapter extends RecyclerView.Adapter<EcomproductfilterAdapter.ViewHolder> {
    ...
    public EcomproductfilterAdapter(Context context, ArrayList<Listmodel> list, OnItemClickListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.activity_ecomm_productfilter_list, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            llhome = itemView.findViewById(R.id.productfilterllhome);
