    ...
    public void spinknowclick() {
        ...
        spinknow.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ((TextView) view).setTextColor(ContextCompat.getColor(RegistationActivity.this, R.color.white));
                    ...
                    public void run() {
                        if (!NetworkUtils.isConnected(RegistationActivity.this)) {
                            ...
                            if (checkBoxTerms.isChecked()) {
                                ...
                                // Checkbox is not checked, show an error or prompt the user to accept the terms
                                Toast.makeText(RegistationActivity.this, "Please accept the terms and policy.", Toast.LENGTH_SHORT).show();
                            }
